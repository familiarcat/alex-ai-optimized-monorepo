...
const n8n_health_manager_1 = require("@/lib/n8n-health-manager");
...
async function HomePage() {
    ...
    try {
        ...
        const healthStatus = await n8n_health_manager_1.n8nHealthManager.waitForN8NHealth(30000); // 30 second timeout
        ...
        return (<react_1.Suspense fallback={<div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        ...
        <client_page_1.default initialHealthStatus={healthStatus}/>
      </react_1.Suspense>);
    }
    catch (error) {
        ...
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <button onClick={() => window.location.reload()} className="mt-6 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
            Retry Connection
          </button>
        </div>
      </div>);
