        ...
        <div className="mb-8">
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-4">
              {subscription?.features.map((feature, index) => (<div key={index} className="flex items-center text-sm text-gray-600">
                  <outline_1.CheckCircleIcon className="h-4 w-4 text-green-500 mr-2 flex-shrink-0"/>
                  {feature}
                </div>))}
            </div>
            ...
            <div className="flex space-x-4">
              ...
              {subscription?.cancelAtPeriodEnd ? (<button className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700">
                  Reactivate Subscription
                </button>) : (<button className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700">
                  Cancel Subscription
                </button>)}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white border rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <outline_1.CreditCardIcon className="h-5 w-5 text-gray-400"/>
              </div>
              ...
              {usageStats?.apiCallsLimit !== -1 && (<div className="mt-2">
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-indigo-600 h-2 rounded-full" style={{ width: `${getUsagePercentage(usageStats?.apiCalls || 0, usageStats?.apiCallsLimit || 0)}%` }}></div>
                  </div>
                </div>)}
            </div>
            ...
            <div className="bg-white border rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <outline_1.CheckCircleIcon className="h-5 w-5 text-gray-400"/>
              </div>
              <div className="text-2xl font-bold text-gray-900">
            ...
            <div className="bg-white border rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <outline_1.ExclamationTriangleIcon className="h-5 w-5 text-gray-400"/>
              </div>
              <div className="text-2xl font-bold text-gray-900">
