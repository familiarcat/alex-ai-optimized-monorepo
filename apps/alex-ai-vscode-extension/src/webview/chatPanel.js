...
exports.AlexAIChatPanel = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
class AlexAIChatPanel {
    constructor(context, alexAIClient, contextManager, crewManager) {
        this.context = context;
        this.alexAIClient = alexAIClient;
        this.contextManager = contextManager;
        this.crewManager = crewManager;
        this._chatHistory = [];
        this._crewMembers = [];
        this._selectedCrewMember = 'Commander Data';
    ...
    async handleSendMessage(text, crewMember) {
        if (!this._view)
            return;
...
exports.AlexAIChatPanel = AlexAIChatPanel;
AlexAIChatPanel.viewType = 'alex-ai-chat-panel';
