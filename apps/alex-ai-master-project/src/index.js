...
exports.AlexAIMasterProjectApp = void 0;
const master_project_js_1 = require("./core/master-project.js");
const memory_hub_js_1 = require("./memory-hub/memory-hub.js");
const n8n_sync_hub_js_1 = require("../n8n-sync-hub/n8n-sync-hub.js");
const analytics_hub_js_1 = require("../analytics-hub/analytics-hub.js");
const deployment_hub_js_1 = require("../deployment-hub/deployment-hub.js");
class AlexAIMasterProjectApp {
    constructor() {
        console.log('🧠 Initializing Alex AI Master Project...');
        // Initialize all hubs
        this.memoryHub = new memory_hub_js_1.MemoryHub();
        this.n8nSyncHub = new n8n_sync_hub_js_1.N8NSyncHub();
        this.analyticsHub = new analytics_hub_js_1.AnalyticsHub();
        this.deploymentHub = new deployment_hub_js_1.DeploymentHub();
        // Initialize master project
        this.masterProject = new master_project_js_1.AlexAIMasterProject({
...
exports.AlexAIMasterProjectApp = AlexAIMasterProjectApp;
// CLI interface
