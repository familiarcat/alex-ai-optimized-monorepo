#!/usr/bin/env python3
"""
Consolidated Script: store_crew_memories_supabase
================================

This script consolidates the following similar scripts:
- ./store_crew_memories_supabase.py
- ./mcp-memory-optimization-milestone-v1.0-20250906_054431/store_crew_memories_supabase.py
...
class SupabaseMemoryStorage:
    def __init__(self):
        self.supabase_url = "https://rpkkkbufdwxmjaerbhbn.supabase.co"
