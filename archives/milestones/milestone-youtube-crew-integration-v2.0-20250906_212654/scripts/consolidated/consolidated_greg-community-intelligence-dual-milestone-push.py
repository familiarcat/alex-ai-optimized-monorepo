#!/usr/bin/env python3
"""
Consolidated Script: greg-community-intelligence-dual-milestone-push
================================

This script consolidates the following similar scripts:
- ./greg-community-intelligence-dual-milestone-push.sh
- ./dual-milestone-push.sh
- ./observation-lounge-unified-crew-dual-milestone-push.sh
