#!/usr/bin/env python3
"""
Consolidated Script: cursor-ai-shell-integration
================================

This script consolidates the following similar scripts:
- ./cursor-extension-milestone-package/cursor-ai-shell-integration.sh
- ./scripts/cursor-ai-shell-integration.sh
