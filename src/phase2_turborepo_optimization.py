...
"""
        ...
        package_json["scripts"]["monitor"] = "node scripts/monitor-performance.js"
...
"""
    ...
    def test_optimizations(self):
        ...
        success, output = self.run_command("node scripts/monitor-performance.js")
        if success:
